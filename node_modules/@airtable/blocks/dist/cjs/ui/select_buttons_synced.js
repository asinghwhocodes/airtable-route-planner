...
var _excluded = ["globalConfigKey", "onChange", "disabled"];
...
var SelectButtonsSynced = (props, ref) => {
  ...
  return /*#__PURE__*/React.createElement(_select_buttons.default, (0, _extends2.default)({}, restOfProps, {
    ref: ref,
    value: selectValue,
    onChange: newValue => {
      setValue(newValue);
...
var ForwardedRefSelectButtonsSynced = /*#__PURE__*/React.forwardRef(SelectButtonsSynced);
...
var _default = exports.default = ForwardedRefSelectButtonsSynced;