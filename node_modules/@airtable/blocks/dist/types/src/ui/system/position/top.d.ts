...
export declare const top: import("@styled-system/core").styleFn;
export declare const topPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
