...
export declare const flex: import("@styled-system/core").styleFn;
export declare const flexPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
