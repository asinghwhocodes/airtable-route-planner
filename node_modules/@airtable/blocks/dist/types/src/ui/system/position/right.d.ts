...
export declare const right: import("@styled-system/core").styleFn;
export declare const rightPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
