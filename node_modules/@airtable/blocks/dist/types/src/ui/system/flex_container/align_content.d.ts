...
export declare const alignContent: import("@styled-system/core").styleFn;
export declare const alignContentPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
//# sourceMappingURL=align_content.d.ts.map