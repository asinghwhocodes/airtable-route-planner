...
export declare const opacity: import("@styled-system/core").styleFn;
export declare const opacityPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
