...
export declare const fontStyle: import("@styled-system/core").styleFn;
export declare const fontStylePropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
//# sourceMappingURL=font_style.d.ts.map