...
export declare const lineHeight: import("@styled-system/core").styleFn;
export declare const lineHeightPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
//# sourceMappingURL=line_height.d.ts.map