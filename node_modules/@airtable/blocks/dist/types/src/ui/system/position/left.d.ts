...
export declare const left: import("@styled-system/core").styleFn;
export declare const leftPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
