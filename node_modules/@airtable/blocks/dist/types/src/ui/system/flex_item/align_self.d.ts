...
export declare const alignSelf: import("@styled-system/core").styleFn;
export declare const alignSelfPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
//# sourceMappingURL=align_self.d.ts.map