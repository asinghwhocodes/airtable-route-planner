...
export declare const display: import("@styled-system/core").styleFn;
export declare const displayPropTypes: import("../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
