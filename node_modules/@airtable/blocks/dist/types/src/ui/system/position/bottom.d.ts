...
export declare const bottom: import("@styled-system/core").styleFn;
export declare const bottomPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
