...
export declare const maxWidth: import("@styled-system/core").styleFn;
export declare const maxWidthPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
//# sourceMappingURL=max_width.d.ts.map