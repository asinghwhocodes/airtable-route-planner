...
export declare const fontSize: import("@styled-system/core").styleFn;
export declare const fontSizePropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
//# sourceMappingURL=font_size.d.ts.map