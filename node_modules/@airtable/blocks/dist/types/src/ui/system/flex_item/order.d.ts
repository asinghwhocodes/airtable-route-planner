...
export declare const order: import("@styled-system/core").styleFn;
export declare const orderPropTypes: import("../../../private_utils").ObjectMap<string, import("prop-types").Validator<any>>;
