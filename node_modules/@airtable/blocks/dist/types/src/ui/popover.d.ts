 ...
 */
export type PopoverPlacementX = PopoverPlacements.LEFT | PopoverPlacements.CENTER | PopoverPlacements.RIGHT;
/**
 * Any of the supported {@link PopoverPlacements} for vertical positioning.
 */
export type PopoverPlacementY = PopoverPlacements.TOP | PopoverPlacements.CENTER | PopoverPlacements.BOTTOM;
/**
...
declare class Popover extends React.Component<PopoverProps> {
    ...
    static propTypes: {
        ...
        fitInWindowMode: PropTypes.Requireable<ObjectValues<typeof FitInWindowModes>>;
