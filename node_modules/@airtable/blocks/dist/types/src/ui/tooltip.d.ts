...
declare class Tooltip extends React.Component<TooltipProps, TooltipState> {
    ...
    static propTypes: {
        ...
        content: PropTypes.Requireable<NonNullable<string | ((...args: any[]) => any) | null | undefined>>;
        ...
        fitInWindowMode: PropTypes.Requireable<import("../private_utils").ObjectValues<typeof import("./popover").FitInWindowModes>>;
